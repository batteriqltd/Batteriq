  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#000022]">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at 50% 50%, #00004d 0%, #000022 100%)'
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-[460px] px-6 py-12">
        ...
        <div className="flex flex-col items-center mb-10 admin-login-animate">
          <div className="relative group">
            <div className="absolute inset-0 bg-blue-500/20 blur-2xl rounded-full scale-150 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
            <img 
              src="/logo.png" 
              alt="Batteriq Logo" 
              className="h-16 w-auto relative z-10 brightness-0 invert" 
              onError={(e) => {
                // If logo fails, we can fallback or hide
