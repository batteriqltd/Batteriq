...
export function ChatWidget() {
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed bottom-24 right-5 z-50 w-72 bg-white rounded-3xl overflow-hidden"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <p className="text-blue-200 text-xs">We are online</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                <p className="font-black text-sm text-gray-900 group-hover:text-white transition-colors">
                  Chat via WhatsApp
                </p>
                <p className="text-xs text-gray-500 group-hover:text-green-100 transition-colors">
                  +254 716 822 014 · Instant reply
                </p>
              </div>
              <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" className="text-green-600 group-hover:text-white transition-colors">
                <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              </svg>
            </a>

            {/* Chat with Agent option */}
            <a
              href="/contact"
              className="flex items-center gap-4 p-4 rounded-2xl border-2 transition-all duration-200 group"
              style={{ borderColor: '#0000ff', background: '#eff6ff' }}
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 group-hover:text-blue-200 transition-colors">
                  Send us a message · 2hr response
                </p>
              </div>
              <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" className="text-blue-600 group-hover:text-white transition-colors">
            ...
            >
              ...
              <div>
                <p className="text-xs font-black text-gray-900">Call us</p>
      ...
      <button
        ...
        style={{
          background: open
            ? 'linear-gradient(135deg, #00004d, #0000ff)'
            : '#25D366',
          boxShadow: open
            ? '0 8px 32px rgba(0,0,255,0.4)'
