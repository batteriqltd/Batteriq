      ...
      <AnimatePresence>
        {!chatOpen && (
          <motion.button
            ...
            onClick={openChat}
            className="fixed bottom-6 left-6 z-40 flex items-center gap-2.5 px-4 py-3 bg-bq-blue text-white font-bold rounded-full shadow-blue-glow hover:bg-bq-blue-dim hover:shadow-blue-glow-lg transition-all"
        ...
        {chatOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 md:bottom-6 md:left-6 z-50 w-full md:w-[380px] h-[85vh] md:h-[600px] flex flex-col bg-bq-gray-900 border border-bq-gray-600 md:rounded-[12px] shadow-2xl overflow-hidden"
              role="dialog"
